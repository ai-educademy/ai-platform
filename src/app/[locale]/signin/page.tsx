  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16 relative">
      ...
      <motion.div
        ...
        initial={noMotion ? undefined : { opacity: 0, scale: 0.95, y: 20 }}
        ...
        <div className="glass rounded-3xl p-8 border border-[var(--color-glass-border)] shadow-lg">
          ...
          >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-card)] font-medium text-sm disabled:opacity-50 cursor-pointer transition-shadow hover:shadow-md hover:shadow-[var(--color-primary)]/5"
              whileHover={noMotion ? undefined : { scale: 1.02, y: -1 }}
              whileTap={{ scale: 0.98 }}
